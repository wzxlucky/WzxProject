...
public class AssetsDatabaseManager {
    ...
    public static void initManager(Context context){
        if(mInstance == null){
            mInstance = new AssetsDatabaseManager(context.getApplicationContext());
        }
    ...
    public String getIconUrlByCid(String cid) {
        if(mInstance!=null&&!TextUtils.isEmpty(cid)&&!"null".equals(cid))
        {
            Cursor cursor = null;
            try {
    ...
    public boolean needProductIconUpdate(String cid,String updated){
        if(mInstance!=null)
        {
            SQLiteDatabase db = mInstance.getDatabase("db");
            Cursor cursor=null;
    ...
    public boolean needProductIconInsert(String cid){
        if(mInstance!=null) {
            SQLiteDatabase db = mInstance.getDatabase("db");
            Cursor cursor=null;
            try {
    ...
    public boolean needproviderIconUpdate(String pid,String updated){
        if(mInstance!=null)
        {
            SQLiteDatabase db = mInstance.getDatabase("db");
